...
class Header(game.Entity):
    ...
    def __init__(self, headline="", title=""):
        ...
        self.title = title
        super(Header, self).__init__((config.HEIGHT, config.HEIGHT))
        self.rect[0] = 4
        self._date = None
    ...
    def render(self, *args, **kwargs):
        ...
        if new_date != self._date:
            ...
            #VERTICALE
            pygame.draw.line(self.image, (95, 255, 177), (5, 15), (30, 15), 2)
            #ORIZZONATALE
            pygame.draw.line(self.image, (95, 255, 177), (70, 15), (1000, 15), 2)
            #pygame.draw.line(self.image, (95, 255, 177), (205, 15), (300, 15), 2)
